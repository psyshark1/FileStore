...
public class forAdminServlet extends HttpServlet {
        ...
        if (accessRole == null || findUser != null) {
            ...
            try {
                ...
                if (mdl.checkLogin(userName, false)) {
                    ...
                    RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/pages/forAdmin.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.setCharacterEncoding("UTF-8");
        RequestDispatcher reqD = request.getRequestDispatcher("pages/forAdmin.jsp");
